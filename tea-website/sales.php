...
<div class="wrapper">
    <div class="sales-header">
        <h2>
            Tea and Teaware on Sale
        </h2>
        <p>
            Every once in a while we've new products on sale. The best way to stay updated is to subscribe to our newsletter or follow us on social media!
        </p>
    </div>
...
// Pobierz produkty z bazy danych zgodnie z typem_towaru
$sql = "SELECT * FROM towary WHERE typ_towaru = 'sales'";
